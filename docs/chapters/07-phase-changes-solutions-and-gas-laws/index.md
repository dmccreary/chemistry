---
title: Phase Changes, Solutions, and Gas Laws
description: Explore phase changes, heating curves, phase diagrams, vapor pressure, solution chemistry, Beer-Lambert Law, and colligative properties in AP Chemistry.
...
<details markdown="1">
<summary>Interactive Heating Curve Simulator</summary>
Type: MicroSim
**sim-id:** heating-curve-simulator<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
**sim-id:** phase-diagram-infographic<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
1. Separating solute particles from each other (endothermic, requires energy).
2. Separating solvent molecules to make room for solute (endothermic, requires energy).
3. Forming new solute-solvent interactions (exothermic, releases energy).
...
1. Generates light of a selected wavelength using a monochromator or filter.
2. Passes the light beam through a sample cuvette containing the solution.
3. Measures the intensity of light that passes through compared to the incident intensity.
...
<details markdown="1">
<summary>Beer-Lambert Law Calibration Curve Builder</summary>
Type: MicroSim
**sim-id:** beer-lambert-calibration<br/>
**Library:** Chart.js<br/>
**Status:** Specified
