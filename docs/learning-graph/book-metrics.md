...
|---|---------|-------|--------|-------|
| 1 | Concepts | 500 | Required | Concepts from learning graph |
| 2 | Chapters | 18 | Required | Chapter directories with index.md |
| 3 | MicroSims | 46 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 2 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 18 / 18 | Recommended | Chapters with a quiz.md (180 questions total) |
| 6 | Chapter References | 6 / 18 | Recommended | Chapters with references.md (60 references total) |
| 7 | Glossary Terms | 472 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 70 | Recommended | Questions in faq.md |
| 9 | Words | 209,887 | Required | Words across student-facing markdown |
...
| Total Words | 209,887 | 134,159 | Words in markdown files |
| Links | 416 | 131 | Hyperlinks in markdown format |
| Equivalent Pages | 878 | 575 | Estimated pages (250 words/page + visuals) |
