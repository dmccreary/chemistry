# Learning Graph for AP Chemistry

[View the Learning Graph Fullscreen](../sims/graph-viewer/main.html){ .md-button .md-button--primary }
...
- Validates course description has sufficient depth for generating 500 concepts
...
- Category organization - foundational elements first, advanced topics last
- Balanced categories (1.6% - 12% each)
